            ...
            <div className="mx-auto w-full max-w-[1600px] px-4 py-6 sm:px-6 lg:px-8 md:py-10 2xl:max-w-none">
                <div className="mb-6 overflow-hidden rounded-[28px] border border-slate-200/80 bg-white/92 shadow-[0_20px_60px_rgba(15,23,42,0.08)] backdrop-blur">
                    ...
                    <div className="grid grid-cols-2 gap-2.5 px-5 py-3 sm:px-6 md:grid-cols-5">
                        ...
                        <div className="rounded-xl border border-emerald-100 bg-emerald-50/35 px-3.5 py-2.5">
                            <p className="text-[10px] font-semibold uppercase tracking-[0.16em] text-emerald-600/80">Confirmadas</p>
                            <p className="mt-1 text-xl font-semibold text-emerald-900">{resumenEstados.confirmadas}</p>
                        </div>
                        ...
                        <div className="rounded-xl border border-blue-100 bg-blue-50/35 px-3.5 py-2.5">
                            ...
                            <p className="mt-1 text-xl font-semibold text-blue-900">{resumenEstados.finalizadas}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="space-y-6">
                    <div className="overflow-hidden rounded-[24px] border border-slate-200 bg-white/94 shadow-[0_14px_34px_rgba(15,23,42,0.06)]">
                        <button
                            ...
                            className="flex w-full items-center justify-between gap-3 border-b border-slate-100 bg-[linear-gradient(180deg,#ffffff_0%,#f8fafc_100%)] px-5 py-4 text-left transition-colors duration-150 hover:bg-slate-50 sm:px-6"
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h2 className="text-sm font-semibold uppercase tracking-[0.16em] text-slate-800">Filtrar búsqueda</h2>
                                    <p className="mt-0.5 text-xs text-slate-500">Paciente, RUT, rango de fechas, profesional y estado.</p>
                                </div>
                            </div>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                className={`h-4 w-4 text-slate-500 transition-transform duration-200 ${mostrarFiltros ? "rotate-180" : ""}`}
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke="currentColor"
                                strokeWidth={2}
                                ...
                                <div className="grid grid-cols-1 gap-4 xl:grid-cols-[1.35fr_1fr]">
                                    <div className="rounded-[22px] border border-slate-200 bg-slate-50/65 p-4">
                                        <div className="mb-3 flex items-center justify-between gap-3">
                                            <div>
                                                <h3 className="text-sm font-semibold text-slate-800">Búsqueda directa</h3>
                                                <p className="mt-0.5 text-[11px] text-slate-500">Encuentra reservas por nombre o RUT del paciente.</p>
                                            </div>
                                            <span className="hidden rounded-full border border-slate-200 bg-white px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.14em] text-slate-400 sm:inline-flex">Paciente</span>
                                        </div>
                                        <div className="space-y-3">
                                            <div>
                                                <label className="mb-1.5 block text-xs font-semibold text-slate-700">Nombre del paciente</label>
                                                <div className="flex flex-col gap-2 sm:flex-row">
                                                    ...
                                                    <button
                                                        ...
                                                        className="inline-flex min-w-[116px] flex-shrink-0 items-center justify-center gap-1.5 rounded-xl bg-[linear-gradient(135deg,#0f172a_0%,#334155_100%)] px-4 py-2 text-xs font-medium text-white shadow-sm transition-all duration-150 hover:brightness-110">
                                            ...
                                            <div>
                                                <label className="mb-1.5 block text-xs font-semibold text-slate-700">RUT del paciente</label>
                                                <div className="flex flex-col gap-2 sm:flex-row">
                                                    <ShadcnInput
                                                        value={rut}
                                    ...
                                    <div className="rounded-[22px] border border-slate-200 bg-[linear-gradient(180deg,#fafafa_0%,#f8fafc_100%)] p-4 md:p-5">
                                        <div className="mb-4 flex items-start justify-between gap-3">
                                            <div>
                                                <h3 className="text-sm font-semibold text-slate-800">Rango de fechas</h3>
                                                <p className="mt-0.5 text-[11px] text-slate-500">Acota el listado por período.</p>
                                            </div>
                                            <span className="inline-flex rounded-full border border-slate-200 bg-white px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.14em] text-slate-400">Fechas</span>
                                        </div>
                                        ...
                                        <button
                                            ...
                                            className="mt-4 inline-flex w-full items-center justify-center gap-1.5 rounded-xl bg-[linear-gradient(135deg,#0369a1_0%,#0f766e_100%)] px-4 py-2.5 text-xs font-medium text-white shadow-sm transition-all duration-150 hover:brightness-110 sm:w-auto">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                                <path strokeLinecap="round" strokeLinejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                                            </svg>
                                            Filtrar por fechas
                                        ...
                                        <TableRow className="hover:bg-transparent">
                                            <TableCell colSpan={8} className="px-4 py-14 text-center">
                                                <div className="mx-auto flex max-w-md flex-col items-center">
                                                    ...
                                                    <p className="mt-4 text-sm font-semibold text-slate-700">No hay reservaciones para mostrar</p>
